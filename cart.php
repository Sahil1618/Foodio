...
echo '<script>alert("Your order has been placed successfully. Pay via COD(Cash on Delivery). Order number is "+"'.$orderno.'")</script>';
...
<head>
    ...
    <title>Foodio | Food Details</title>
                ...
                <div class="page-title-wrapper text-center">
					<div class="col-md-12 col-sm-12 col-lg-12">
						<div class="page-title-inner">
							<h1 itemprop="headline" style="color: yellow;">Your Cart 🛒</h1>
...
<td colspan="3">
<input type="text" name="flatbldgnumber"  placeholder="Flat or Building Number(Required Field)" class="form-control" required="true"></td>
<td colspan="3">
<input type="text" name="streename" placeholder="Street Name(Required Field)" class="form-control" required="true">      
</td>
</tr>
<tr>
<td colspan="3"> 
<input type="text" name="area"  placeholder="Area(Required Field)" class="form-control" required="true">
</td>
<td colspan="3">
...
<tr>
<td colspan="3"> 
<input type="text" name="city" placeholder="City(Required Field)" class="form-control" required ="true">  
</td>
</tr>
<tr>
    <td colspan="3">
       <!-- <button   type="submit" name="placeorder" class="red-bg btn theme-btn btn-lg">Place order</button> -->
       <button type="submit" name="placeorder" class="red-bg btn theme-btn btn-lg" onclick="animateButton()">Place order</button>
...
<script>
  function animateButton() {
    // You can add your code here for placing the food order
...
<?php } else {?>
    ...
    <tr>
    <td colspan="6" style="color:red; animation: pulse 1.5s infinite;">Your cart is empty 😢</td>
</tr>
