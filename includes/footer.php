  <footer>
                                ...
                                <div class="row">
                                    <div class="col-md-3 col-sm-6 col-lg-3">
                                        <div class="widget about_widget wow fadeIn" data-wow-delay="0.1s">
                                            <div class="logo"><h1 itemprop="headline"><a href="index.php" title="Home" itemprop="url" style="color:#fff">Foodio</a></h1></div>
                                    ...
                                    <div class="col-md-3 col-sm-6 col-lg-3" style="text-align: left;">
            ...
            <div class="container">
    <p itemprop="description"><h4 style="color: white;">Foodio | Made with &hearts; by Sahil Sharma and Sahil Rajput © 2023</h4></p>
</div>
        </div><!-- Bottom Bar -->