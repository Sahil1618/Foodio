...
error_reporting(0);
   ?>
    ...
    ?>
        <a href="my-account.php" title="My Account" itemprop="url"><?php echo $userName; ?></a>
    <?php } ?>
</div>
            ...
            <div class="logo-menu-sec">
                <div class="container">
                    <div class="logo"><h1 itemprop="headline"><a href="index.php" title="Home" itemprop="url">Foodio</a></h1></div>
                    <nav>
                        <div class="menu-sec">
                            <ul>
<li><a href="index.php" title="Home" itemprop="url">Home</li>

<li class="menu-item-has-children"><a href="our-menu.php" title="Menu" itemprop="url">Food Menu</a>
...
<li><a href="contact-us.php" title="Contact us" itemprop="url">Contact us </a></li>
         ...
         <?php if (strlen($_SESSION['fosuid']==0)) {?> 
                ...
                <?php }?>
                                   ...
                                   <?php if (strlen($_SESSION['fosuid']>0)) {?>
                            <a class="black-bg brd-rd4" href="cart.php" title="Register" itemprop="url">My Cart</a>
                        <?php } ?>
                        </div>
                    </nav><!-- Navigation -->
                </div>
...
<li><a href="contact-us.php" title="Contact us" itemprop="url">Contact us </a></li>
   ...
   <a  href="my-account.php" title="My Account" itemprop="url">My Account</a>
    ...
    <?php }?>
    <?php if (strlen($_SESSION['fosuid']>0)) {?>
        <a href="my-account.php" title="My Account" itemprop="url"><?php echo $_SESSION['fosuname']; ?></a>
    <?php } ?>
</div>
                <
                <div class="social1">
