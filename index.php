...
//     // Define the minimum limit for the food quantity
//     $minFoodQty = 1;
    
//     // Check if the entered food quantity is above the minimum limit
//     if($foodqty >= $minFoodQty)
//     {
...
//     else
//     {
//         echo "<script>alert('Minimum food quantity should be $minFoodQty');</script>";
//     }
// }
if(isset($_POST['addcart']))
{
    ...
    // Define the minimum and maximum limits for the food quantity
    $minFoodQty = 1;
    $maxFoodQty = 30;

    // Check if the entered food quantity is within the allowed range
    if($foodqty >= $minFoodQty && $foodqty <= $maxFoodQty)
    {
        $query = mysqli_query($con, "INSERT INTO tblorders(UserId, FoodId, FoodQty) VALUES('$userid', '$foodid', '$foodqty')");
        if($query)
        {
    ...
    {
        echo "<script>alert('Food quantity should be between $minFoodQty and $maxFoodQty');</script>";
    }
}
?>
<!DOCTYPE html>
...
<?php include_once('includes/header.php');?>
        ...
        <section>
            <div class="block less-spacing bg-success top-padd30">
                <div class="container">
                    <div class="row">
...
if (isset($_GET['page_no']) && $_GET['page_no']!="") {
	...
	?>
                                        ...
                                        <div class="popular-dish-box style2 wow fadeIn" data-wow-delay="0.2s">
                                            <div class="popular-dish-thumb">
                                                <a href="food-detail.php?fid=<?php echo $row['ID'];?>" title="" itemprop="url"><img src="admin/itemimages/<?php echo $row['Image'];?>" alt="<?php echo $row['ItemName'];?>" itemprop="image" width="400" height="350"></a>
                                            </div>
    ...
    <p itemprop="description">
        ...
        <input class="qty" name="foodqty" type="number" min="<?php echo $minFoodQty;?>" value="<?php echo $minFoodQty;?>" required>
    </p>
